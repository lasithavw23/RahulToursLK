...
export const CTA_IMAGE = "https://pixabay.com/get/g16d294b5389cfbbf074e9636686dda03ecca8ae253bf30c6b487956520834c19d875cbc8dd3812c526dff9a5ed1535766b0095e1b84f3d95d2b940e05331ceca_1280.jpg";
...
export const EXPERIENCES = [
  {
    ...
    description: "Explore Sri Lanka's stunning landscapes from misty mountains to lush rainforests with expert guides who know the hidden trails.",
    color: "bg-primary",
  },
  {
    icon: "fa-utensils",
    title: "Culinary Journeys",
    description: "Sample authentic Sri Lankan cuisine with cooking classes, market tours, and meals with local families to taste the island's flavors.",
    color: "bg-secondary",
  },
  {
    icon: "fa-water",
    title: "Ocean Adventures",
    description: "Dive into the crystal-clear waters for snorkeling, surfing, or whale watching expeditions along Sri Lanka's picturesque coastline.",
    color: "bg-accent",
  },
  {
    icon: "fa-spa",
    title: "Wellness Retreats",
    description: "Rejuvenate mind and body with traditional Ayurvedic treatments, yoga sessions, and meditation in serene natural settings.",
