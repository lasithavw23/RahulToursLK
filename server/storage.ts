...
export class MemStorage implements IStorage {
  ...
  `,
      ...
      },
      {
        ...
        shortDescription: "Discover the magic of Sri Lanka's hill country with waterfalls, iconic bridges, panoramic hikes, and a world-famous train ride through lush tea plantations.",
        description: `
  ...
  `,
        ...
        places: [
          {
            ...
            shortDescription: "Marvel at one of Sri Lanka's most famous and accessible waterfalls.",
            description: "Rawana Waterfall is a spectacular 25-meter cascade nestled amid lush greenery just outside Ella. Its dramatic drop and natural pools make it a favorite for both sightseeing and photography. Local legend links the falls to the ancient Ramayana epic, adding a touch of myth to its natural beauty."
          },
          {
            title: "Nine Arch Bridge",
            imagePreview: "https://yourcdn.com/images/nine-arch-bridge.jpg",
            shortDescription: "Walk across Ella's iconic colonial-era railway bridge, surrounded by tea plantations.",
            description: "The Nine Arch Bridge is a marvel of early 20th-century engineering, famous for its nine elegant stone arches and lush jungle backdrop. Watch the blue train pass overhead for a classic Ella photo opportunity, or stroll the nearby trails for the best views of this architectural gem."
          },
          {
            title: "Little Adam's Peak",
            imagePreview: "https://yourcdn.com/images/little-adams-peak.jpg",
            shortDescription: "Hike to panoramic viewpoints overlooking the Ella Gap and highlands.",
            description: "Little Adam's Peak offers an accessible trek with rewarding vistas of Ella's rolling hills, tea estates, and distant mountain ranges. The gentle ascent is suitable for all fitness levels, making it one of Ella's most popular attractions for sunrise or sunset."
          },
          {
            title: "Scenic Train Ride (Ella Demodara to Haputale)",
            imagePreview: "https://yourcdn.com/images/ella-train-ride.jpg",
            shortDescription: "Ride the world-famous hill country train through tunnels, bridges, and tea fields.",
            description: "Board the train at Ella or Demodara for an unforgettable journey to Haputale, passing over the Nine Arch Bridge and through the engineering marvel of the Demodara Loop. This route is celebrated for its breathtaking scenery, cool mountain air, and authentic Sri Lankan rail experience."
          },
          {
            title: "Haputale Tea Plantation",
            imagePreview: "https://yourcdn.com/images/haputale-tea.jpg",
            shortDescription: "Tour a working tea estate and sample fresh Ceylon tea in the highlands.",
            description: "Haputale's tea plantations are famed for producing some of Sri Lanka's finest Ceylon tea. Walk through lush green fields, learn about the tea-making process from plucking to brewing, and enjoy tastings with sweeping views of the misty hills."
          }
        ],
        mapLink: "https://www.google.com/maps/d/embed?mid=1kUeMB-ella-tour-map&hl=en",
        gallery: [
        ...
        metaTitle: "Ella Scenic Highlands Tour | Nine Arch Bridge, Rawana Waterfall, Little Adam's Peak & Train Ride",
        metaDescription: "Book the Ella Scenic Highlands Tour to explore Rawana Waterfall, Nine Arch Bridge, Little Adam's Peak, a scenic train ride to Haputale, and a tea plantation visit. Discover the best of Sri Lanka's hill country in one day.",
        keywords: [
          "Ella tour",
        ...
        structuredData: JSON.stringify({
          ...
          "description": "Experience Ella's top attractions including Rawana Waterfall, Nine Arch Bridge, Little Adam's Peak, a scenic train ride to Haputale, and a tea plantation tour. The ultimate Sri Lanka hill country adventure.",
          "image": [
            "https://yourcdn.com/images/ella-nine-arch-bridge.jpg",
            "https://yourcdn.com/images/ella-rawana-falls.jpg",
            "https://yourcdn.com/images/ella-little-adams-peak.jpg"
      ...
      },
      {
        ...
        shortDescription: "Experience an unforgettable wildlife adventure in Yala National Park with a private jeep, complimentary water, and onboard WiFi.",
        description: `
  ...
  `,
        ...
        metaTitle: "Yala Safari Tour | Private Jeep Safari in Yala National Park Sri Lanka",
        metaDescription: "Book your Yala Safari Tour for a thrilling wildlife adventure in Sri Lanka's Yala National Park. Spot leopards, elephants, and more with a private jeep, water, and WiFi included.",
        keywords: [
          "Yala Safari Tour",
        ...
        structuredData: JSON.stringify({
          ...
          "description": "Experience a private jeep safari in Yala National Park, Sri Lanka. Spot leopards, elephants, and more. Includes water, WiFi, and expert guides.",
          "image": [
            "https://yourcdn.com/images/yala-leopard.jpg",
            "https://yourcdn.com/images/yala-elephants.jpg",
            "https://yourcdn.com/images/yala-birds.jpg"
