...
export default function Tours() {
  ...
  return (
    <>
      <Helmet>
        <title>Tours & Experiences - Rahul Tours Sri Lanka</title>
        <meta
          name="description"
      ...
      <div className="bg-primary-dark text-white py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg max-w-2xl mx-auto opacity-90">
            ...
            Each experience is designed to showcase the very best of our
            beautiful island.
          </p>
        </div>
      </div>
            ...
            {isLoading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className="h-96 bg-neutral-200 dark:bg-neutral-800 animate-pulse rounded-xl"
                  ></div>
                ))}
              </div>
