export const sigiriyaDambullaTour = {
  id: 1,
  slug: "sigiriya-dambulla-tour",
  title: "Sigiriya & Dambulla UNESCO Heritage Day Tour",
  shortDescription:
    "Experience Sri Lanka's ancient wonders on a day tour to Sigiriya Rock Fortress and Dambulla Cave Temple-two must-see UNESCO World Heritage Sites.",
  description: `
    Embark on the ultimate cultural adventure with our Sigiriya & Dambulla UNESCO Heritage Day Tour. Ascend the legendary Sigiriya Rock Fortress-often called the 'Eighth Wonder of the World'-and marvel at its ancient frescoes, water gardens, and breathtaking panoramic views. Explore the Dambulla Golden Cave Temple, Sri Lanka's largest and best-preserved cave temple complex, adorned with over 150 Buddha statues and vibrant murals dating back more than 2,000 years.
  ...
  places: [
    {
      ...
      shortDescription:
        "Climb the iconic Lion Rock and explore the ancient royal citadel of Sigiriya.",
      description:
        "Sigiriya Rock Fortress, a UNESCO World Heritage Site, is renowned for its dramatic 200-meter-high granite peak, ancient royal palace ruins, and exquisite frescoes. Ascend approximately 1,200 steps to reach the summit, passing the famous Mirror Wall and Lion's Paw Terrace. At the top, enjoy panoramic views of lush landscapes and discover the remains of King Kashyapa's 5th-century palace. Sigiriya is celebrated as one of Asia's most impressive archaeological sites."
    },
    {
  ...
  metaTitle:
    "Sigiriya & Dambulla Day Tour | UNESCO World Heritage Sites Sri Lanka",
  metaDescription:
    "Book your Sigiriya & Dambulla Day Tour to explore Sri Lanka's top UNESCO World Heritage Sites. Climb Sigiriya Rock Fortress, visit Dambulla Cave Temple, and enjoy expert local guidance on this unforgettable cultural adventure.",
  keywords: [
    "Sigiriya tour",
    "Dambulla tour",
  ...
  structuredData: JSON.stringify({
    ...
    "description":
      "Discover Sri Lanka's UNESCO World Heritage Sites on a guided day tour to Sigiriya Rock Fortress and Dambulla Cave Temple. Includes expert guide, transfers, and skip-the-line entry.",
    "image": [
      "https://pixabay.com/get/ge873304aac92154d4e9587c9614f77b133f4d1b12233f27eecaf54d2b5620a637a65afa978023ec0816e993849fdafa4fdcd10130be56b66496118145b7fde81_1280.jpg",
      "https://pixabay.com/get/g3fe4cdfa53cc79c4f8b2a3ce56b7ef2e16b7a40b5433407cfbf82a8a47a94f5e38eb9b28a2c59af686acd2fd0a6ce307db32b0e693cfab11b53c9c462c456edd_1280.jpg"
    ],
